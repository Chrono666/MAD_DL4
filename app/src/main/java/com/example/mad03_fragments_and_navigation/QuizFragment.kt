...
class QuizFragment : Fragment() {
    ...
    private fun nextQuestion() {
        ...
        if (selectedRadioButtonId == -1) {
            ...
            val radioButton: View = binding.answerBox.findViewById<View>(selectedRadioButtonId)
            answerIndex = binding.answerBox.indexOfChild(radioButton)
            binding.question.answers[answerIndex].isCorrectAnswer
        }
